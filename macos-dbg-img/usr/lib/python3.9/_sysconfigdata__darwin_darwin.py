...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/Volumes/dbg-ve/usr/bin',
 'BINLIBDEST': '/Volumes/dbg-ve/usr/lib/python3.9',
 'BLDLIBRARY': '-L. -lpython3.9',
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup -arch x86_64 '
              '-L/Volumes/dbg-ve/usr/lib',
 'BUILDEXE': '.exe',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.13 '
           '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-arch x86_64 -mmacosx-version-min=10.13 '
                     '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-mmacosx-version-min=10.13 '
                       '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 'CONFIGURE_LDFLAGS': '-arch x86_64 -L/Volumes/dbg-ve/usr/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/Volumes/dbg-ve/usr' "
                "'--exec-prefix=/Volumes/dbg-ve/usr' "
                "'--oldincludedir=/Volumes/dbg-ve/usr/include' "
                "'--enable-universalsdk' '--with-universal-archs=intel-64' "
                "'--enable-optimizations' "
                "'--with-openssl=/Users/venge/lldb-s13/Python-3.9.9/../ssl' "
                "'--enable-shared' 'MACOSX_DEPLOYMENT_TARGET=10.13' "
                "'CFLAGS=-mmacosx-version-min=10.13 "
                "-I/Users/venge/lldb-s13/gettext-0.21/build-install/include' "
                "'LDFLAGS=-L/Volumes/dbg-ve/usr/lib' "
                "'CPPFLAGS=-mmacosx-version-min=10.13 "
                "-I/Users/venge/lldb-s13/gettext-0.21/build-install/include'",
 'CONFINCLUDEDIR': '/Volumes/dbg-ve/usr/include',
 'CONFINCLUDEPY': '/Volumes/dbg-ve/usr/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/venge/lldb-s13/Python-3.9.9/coverage.info',
 'COVERAGE_REPORT': '/Users/venge/lldb-s13/Python-3.9.9/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -mmacosx-version-min=10.13 '
             '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 'CXX': 'g++',
 'DESTDIRS': '/Volumes/dbg-ve/usr /Volumes/dbg-ve/usr/lib '
             '/Volumes/dbg-ve/usr/lib/python3.9 '
             '/Volumes/dbg-ve/usr/lib/python3.9/lib-dynload',
 'DESTLIB': '/Volumes/dbg-ve/usr/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/Volumes/dbg-ve/usr/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Volumes/dbg-ve/usr/include /Volumes/dbg-ve/usr/include '
                   '/Volumes/dbg-ve/usr/include/python3.9 '
                   '/Volumes/dbg-ve/usr/include/python3.9',
 'INCLUDEDIR': '/Volumes/dbg-ve/usr/include',
 'INCLUDEPY': '/Volumes/dbg-ve/usr/include/python3.9',
 ...
 'LDFLAGS': '-arch x86_64 -L/Volumes/dbg-ve/usr/lib',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/Volumes/dbg-ve/usr/lib/python3.9',
 'LIBDIR': '/Volumes/dbg-ve/usr/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Volumes/dbg-ve/usr/lib/pkgconfig',
 'LIBPL': '/Volumes/dbg-ve/usr/lib/python3.9/config-3.9-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Volumes/dbg-ve/usr/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '10.13',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/Volumes/dbg-ve/usr/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/venge/lldb-s13/Python-3.9.9/../ssl/include',
 'OPENSSL_LDFLAGS': '-L/Users/venge/lldb-s13/Python-3.9.9/../ssl/lib',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.13 '
              '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I. -I./Include -mmacosx-version-min=10.13 '
                   '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-arch x86_64 -L/Volumes/dbg-ve/usr/lib',
 'PY_CPPFLAGS': '-I. -I./Include -mmacosx-version-min=10.13 '
                '-I/Users/venge/lldb-s13/gettext-0.21/build-install/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-arch x86_64 -L/Volumes/dbg-ve/usr/lib',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Users/venge/lldb-s13/Python-3.9.9',
 'SCRIPTDIR': '/Volumes/dbg-ve/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Users/venge/lldb-s13/Python-3.9.9 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Users/venge/lldb-s13/Python-3.9.9 '
 ...
 'abs_builddir': '/Users/venge/lldb-s13/Python-3.9.9',
 'abs_srcdir': '/Users/venge/lldb-s13/Python-3.9.9',
 'datarootdir': '/Volumes/dbg-ve/usr/share',
 'exec_prefix': '/Volumes/dbg-ve/usr',
 'prefix': '/Volumes/dbg-ve/usr',
 'srcdir': '.'}
